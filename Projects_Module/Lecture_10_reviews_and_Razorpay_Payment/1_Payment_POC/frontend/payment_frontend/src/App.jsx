...
function loadScript() {
  return new Promise(function (resolve, reject) {
    ...
    //onload and onerror are the two events on the script
...
async function displayRazorpay() {
  // first part will be to load the script
  try {
    await loadScript();
...
function App() {
  return (
    <>
      ...
      <h1>Payment Demo</h1>
      <div className="card">
        <a onClick={displayRazorpay} target="_blank" rel="noopener noreferrer">
          Pay for 500 rs
        </a>
      </div>
