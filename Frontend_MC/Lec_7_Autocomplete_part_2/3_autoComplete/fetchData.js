...
//if there is a new request abort the previous one
/*we have to cancel the previous request.If you are calling the function again there is only one way
 *you have to use closure.If you are calling the function again to know about the previous one then then you
 *have to use a variable outside that function
 ***/
