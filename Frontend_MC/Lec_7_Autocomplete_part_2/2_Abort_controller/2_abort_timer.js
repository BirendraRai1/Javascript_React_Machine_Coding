// abortController can be implemented using setTimeout timeout after 2 seconds
// inbuilt API
...
/*use case of abort controller if there is a time and you got a response then it is ok otherwise your request gets cancelled
 ******/
