...
function updateStars(rating){
  allStars.forEach((allStar,i)=>{
    allStar.classList.remove("yellow")
    if(i+1<=rating){
      allStar.classList.add("yellow")
    }
  })
}

//Jasbir Sir Star rating
